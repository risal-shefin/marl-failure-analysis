...
from modules.constants import DEFAULT_INFLUENCE_DECAY_LAMBDA, DEVICE
from modules.detection import get_patient_zero_detection
from modules.experiments import EpisodeRunner, ExperimentDataLogger, ReferenceTaylorManager
...
class MultiSeedExperimentRunner:
    ...
    def setup_experiment(self):
        ...
        self.runner = Runner_MAPPO_Multigrid(self.config, self.config.env_id, number=1, seed=self.config.seed)
