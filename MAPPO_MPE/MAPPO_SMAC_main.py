...
class Runner_MAPPO_SMAC:
    def __init__(self, args, env_name, number, seed):
        ...
        # Determine episode limit from environment if available
        self.args.episode_limit = getattr(self.env, 'episode_limit', self.args.episode_limit)
        ...
        # Only for homogenous agents environments, all agents have the same dimension
    ...
    def run(self, ):
        ...
        while self.total_steps < self.args.max_train_steps:
            ...
            if train_step_count // self.args.evaluate_freq > evaluate_num:
    ...
    def evaluate_policy(self):
        ...
        for _ in range(self.args.evaluate_times):
            episode_reward, _ = self.run_episode_smac(evaluate=True)
