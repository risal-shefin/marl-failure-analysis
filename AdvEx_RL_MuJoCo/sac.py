...
import cv2
from .network import GaussianPolicy, QNetwork, DeterministicPolicy, QNetworkConstraint, StochasticPolicy, grad_false
from .utils import *
        ...
        with torch.no_grad():
          ...
          if self.adv:
            ...
            min_qf_next_target = torch.min(qf1_next_target, qf2_next_target) - self.alpha * next_state_log_pi
             #   if self.adv_agent:
            # print("###", torch.min(qf1_next_target, qf2_next_target).shape, (self.alpha * next_state_log_pi).shape)
