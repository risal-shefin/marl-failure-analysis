...
def parse_maze():
    ...
    parser.add_argument('--saved_model_path', default='/AdvEx_RL_MuJoCo/AdvEx_RL_Trained_Models_New/Safety_policy/Nov-08-2024|22:29|PM_SafetyAgent_maze_final/Recovery_model/Best/Nov-10-2024_Best_Recovery_Model_safety_ratio1.0/recovery_policy', help='exterior log directory')
    #=========================================================================================================
...
def parse_nav2():
    ...
    parser.add_argument('--saved_model_path', default='/AdvEx_RL_MuJoCo/AdvEx_RL_Trained_Models_New/Safety_policy/Jul-28-2022_01_05_AM_SafetyAgent_nav2/Recovery_model/Best/Jul-28-2022_Best_Recovery_Model_safety_ratio1.0/recovery_policy', help='exterior log directory')
    #=========================================================================================================
    parser.add_argument('--gamma',type=float,default=0.99,help='discount factor for reward (default: 0.99)')
    parser.add_argument( '--tau',type=float,default=0.005, help='target smoothing coefficient(τ) (default: 0.005)')
    parser.add_argument('--alpha',type=float, default=0.20, help='Temperature parameter α determines the relative importance of the entropy\
