...
def parse_maze():
    ...
    # parser.add_argument('--saved_model_path', default='/AdvEx_RL_Trained_Models_New/Adversary/Jul-28-2022_02_55_AM_SAC_maze_Gaussian/adversary_agent/Agent_model/Best_Agent_Model/DateTime_Jul-28-2022_reward_1.0', help='exterior log directory')
    parser.add_argument('--saved_model_path', default='/AdvEx_RL_MuJoCo/AdvEx_RL_Trained_Models_New/Adversary/Nov-07-2024|16:35|PM_SAC_maze_Gaussian/adversary_agent/Agent_model/Best_Agent_Model/DateTime_Nov-08-2024_reward_1.0', help='exterior log directory')
    parser.add_argument('--shield_threshold', type=float, default=0.4, help='Shield threshold value default .97')  
    #=========================================================================================================
...
def parse_nav1():
    ...
    #===============================================================
    parser.add_argument('--hidden_size', type=int, default=512, help='hidden size (default: 256)')
    parser.add_argument('--saved_model_path', default='/AdvEx_RL_MuJoCo/AdvEx_RL_Trained_Models_New/Adversary/Jul-28-2022_21_11_PM_SAC_nav1_Gaussian/adversary_agent/Agent_model/Best_Agent_Model/DateTime_Jul-28-2022_reward_1.0', help='exterior log directory')
...
def parse_nav2():
    ...
    #===============================================================
    parser.add_argument('--hidden_size', type=int, default=512, help='hidden size (default: 256)')
    parser.add_argument('--saved_model_path', default='/AdvEx_RL_MuJoCo/AdvEx_RL_Trained_Models_New/Adversary/Jul-27-2022_21_38_PM_SAC_nav2_Gaussian/adversary_agent/Agent_model/Best_Agent_Model/DateTime_Jul-27-2022_reward_1.0', help='exterior log directory')
