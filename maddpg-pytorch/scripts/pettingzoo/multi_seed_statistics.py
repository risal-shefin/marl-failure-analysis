...
class MultiSeedExperimentRunner:
    ...
    def _load_reference_taylor_cache(self):
        ...
        if self.reference_taylor_cache['env_id'] != self.config.env_id:
            print(f"Warning: Environment ID mismatch: saved={self.reference_taylor_cache['env_id']}, current={self.config.env_id}")
    ...
    def run_normal_episode(self, seed):
        ...
        while True:
            ...
            #     self.maddpg, obs, list(actions.values()), self.env.action_space
            # )
            # pairwise_action_influences = compute_second_order_action_influences(
            #     self.maddpg, obs, list(actions.values()), self.env.action_space
            # )
    ...
    def log_directional_derivatives(self, directional_derivatives_history, seed, episode_length):
        ...
        # Initialize storage for directional derivatives if not exists
    ...
    def save_directional_derivatives_csv(self):
        ...
        """
        if not hasattr(self, 'directional_derivatives_data') or not self.directional_derivatives_data:
