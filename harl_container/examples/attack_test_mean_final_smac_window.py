...
# 
    ...
    results__normal, pairwise_obs_influences_history_normal, pairwise_second_order_influences_history_normal, frob_norms_matrix_history_atk_normal, fault_timeline_atk_normal, attacked_steps_atk_normal = eval(
        runner, 
        attack_status=False, 
    ...
    exit("Exiting for debug")
    results_attacked, frob_norms_atk, sec_dir_derivatives_atk, frob_norms_matrix_history_atk, fault_timeline_atk, attacked_steps_atk = eval(
        runner, 
        attack_status=True, 
        attack_agent_id=attack_agent_id, 
        seed=args['seed'], 
